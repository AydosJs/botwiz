        ...
        <div className="min-h-[calc(100vh-280px)] flex items-center justify-center">
          <div className="">
            <div className="flex items-center justify-center">
              <span className="inline-block bg-[#320f15] p-6 cursor-pointer rounded-full border-4 border-[#fa4d6b] drop-shadow-2xl  animate-bounce">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-12 h-12 sm:w-20 sm:h-20 text-[#fa4d6b]">
                  <path d="M12.232 4.232a2.5 2.5 0 0 1 3.536 3.536l-1.225 1.224a.75.75 0 0 0 1.061 1.06l1.224-1.224a4 4 0 0 0-5.656-5.656l-3 3a4 4 0 0 0 .225 5.865.75.75 0 0 0 .977-1.138 2.5 2.5 0 0 1-.142-3.667l3-3Z" />
                  <path d="M11.603 7.963a.75.75 0 0 0-.977 1.138 2.5 2.5 0 0 1 .142 3.667l-3 3a2.5 2.5 0 0 1-3.536-3.536l1.225-1.224a.75.75 0 0 0-1.061-1.06l-1.224 1.224a4 4 0 1 0 5.656 5.656l3-3a4 4 0 0 0-.225-5.865Z" />
                </svg>
              </span>
            </div>
            <h1 className="text-3xl sm:text-5xl font-bold mb-6 mt-10 text-center">The Time-Traveling Teapot</h1>
            <p className="text-sm sm:text-lg text-gray-400 text-center">
              Tucked away in a dusty antique shop, a chipped teapot holds a world far grander than its porcelain shell. When young Emily stumbles upon its secret, she finds herself whisked through time with every cup she brews.
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-32">
            ...
            <div className="flex flex-col-reverse space-y-4 md:space-y-0 md:flex-row md:space-x-4 text-left items-center">
              <div className="w-full md:w-1/2">
                <h1 className="text-4xl mb-4 font-semibold text-[#fa4d6b]">
